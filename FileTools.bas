...
Public Function FolderBrowser(Optional ByVal sTitle As String = "Please select a folder:", _
  ...
  sPath = Space$(512)
  If SHGetPathFromIDList(ByVal SHBrowseForFolder(bInf), ByVal sPath) Then
...
Public Function FolderExist(ByVal sDirName As String) As Boolean
  ...
  FolderExist = LenB(Dir(FixPath(sDirName) & "*.*", vbDirectory))
  Err.Number = 0
  On Error GoTo 0

End Function

':)Code Fixer V2.9.6 (8/02/2005 11:19:31 AM) 66 + 159 = 225 Lines Thanks Ulli for inspiration and lots of code.
